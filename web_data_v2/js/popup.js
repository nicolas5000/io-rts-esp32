(function () {
    ...
    function openPopup(app, title, label, items, content, options) {
        ...
        boolLabel.textContent = popupOptions.booleanLabel || app.i18nText("popup.boolean_label_default", "Active");
        ...
        repeatLabel.textContent = popupOptions.repeatOnNoResponseLabel ||
            app.i18nText("popup.repeat_on_no_response", "Repeat command if device does not respond");
        ...
        saveBtn.onclick = function () {
            ...
            if (showInput && typeof value === "string" && !value.trim()) {
                showToast(app.i18nText("popup.name_required", "Name cannot be empty."), "error");
                return;
            }
